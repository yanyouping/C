...
namespace Util
{
    ...
    {
        private static DateTime LTCX = new DateTime(2013, 05, 01);
        private static DateTime UTCX = LTCX.ToUniversalTime();
        ...
        private static int __staticIncrement = 0;//(new Random()).Next();
        ...
        {
            get { return LTCX.AddSeconds(Timestamp); }
        }
        ...
        {
            var s = TimeZoneInfo.ConvertTimeToUtc(timestamp) - UTCX;
            var secondsSinceEpoch = (long)Math.Floor(s.TotalSeconds);
